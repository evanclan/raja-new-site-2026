...
const DICTIONARY = {
  ...
  ja: {
    ...
    hero: {
      overline: "空より広く、海より深く、太陽よりあたたかい",
    ...
    panels: {
      ...
      preschool: {
        ...
        href: "https://www.raja-preschool.com",
        title: "より広く、\nより輝ける未来へ。",
        subtitle: "０～２歳対象の企業主導型保育園",
        ages: "0 〜 2 歳",
        description:
          "インターナショナルスクールならではの、こどもたちがひとりの人として尊重され、「心の垣根をつくらない」のびのびとした保育と、育ちの環境をデザインしています。",
        ...
        branches: [
          {
            name: "ラジャ・インターナショナル保育園（下荒田）",
            sub: "Shimo Arata",
            line: "いちばん小さな毎日が、ここから。",
            addr: "〒890-0056 鹿児島市下荒田1-38-32-1",
            tel: "099-204-9149",
            hours: "通常保育・病児保育",
            alt: "ラジャ・インターナショナル保育園（下荒田）。〒890-0056 鹿児島市下荒田1-38-32-1、TEL 099-204-9149、通常保育・病児保育。",
          },
          {
            name: "RaJA病児保育園（下荒田に併設）",
            sub: "下荒田",
            line: "登園できない日も、やさしく見守ります。",
            addr: "〒890-0056 鹿児島市下荒田1-38-32-1",
            tel: "099-204-9149",
            hours: "病児保育・要予約",
            alt: "RaJA病児保育園（下荒田に併設）。〒890-0056 鹿児島市下荒田1-38-32-1、TEL 099-204-9149、病児保育・要予約。",
          },
          {
            name: "ラジャ・インターナショナル保育園 谷山ベース",
            sub: "Taniyama",
            line: "明るく、あたたかい、はじめのおうち。",
            addr: "〒891-0141 鹿児島市谷山中央7丁目27-3",
            tel: "099-204-9851",
            hours: "通常保育",
            alt: "ラジャ・インターナショナル保育園 谷山ベース。〒891-0141 鹿児島市谷山中央7丁目27-3、TEL 099-204-9851、通常保育。",
          },
        ],
      },
      clab: {
      ...
      english: {
        label: "Let's Go English",
        href: "https://www.raja-english.com",
        title: ["「学問」から、", "「ライフスキル」へ。"],
        tagline: "「勉強する」から、「使える」へ。",
        description:
          "応用言語学に基づき、バイリンガルの日本人講師×ネイティブスピーカーの組合せで教えるのがRaJA流！日本人の思考回路に合わせたわかりやすくて楽しいレッスンをお届けしています。留学など、目的に合ったオーダーメイドレッスンも可能です。",
